local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', '<Leader>wa',
                   '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', options)
    buf_set_keymap('n', '<Leader>wr',
                   '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', options)
    ...
    buf_set_keymap("n", "<Leader>bf", "<cmd>lua vim.lsp.buf.formatting()<CR>",
                   options)
end
